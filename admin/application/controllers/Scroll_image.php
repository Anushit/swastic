...
class Scroll_image extends MY_Controller {
	...
	public function datatable_json(){				   					   
		...
		{  
			...
			$data[]= array(
				...
				'<a title="Edit" class="update btn btn-sm btn-warning" href="'.base_url('scroll_image/edit/'.$row['id']).'"> <i class="fa fa-pencil-square-o"></i></a>
				<a title="Delete" class="delete btn btn-sm btn-danger" href='.base_url("scroll_image/delete/".$row['id']).' title="Delete" onclick="return confirm(\'Do you want to delete ?\')"> <i class="fa fa-trash-o"></i></a>'
	...
	{		
		$this->db->delete('ci_scroll_images', array('id' => $id));

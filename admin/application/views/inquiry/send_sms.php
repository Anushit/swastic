      ...
      <div class="card card-default color-palette-bo ">
        <div class="card-header">
          <div class="d-inline-block">
              <h3 class="card-title"><a href="<?php echo base_url('inquiry') ?>"> <i class="fa fa-arrow-left" aria-hidden="true"></i></a>&nbsp   <i class="fa fa-commenting-o"></i>
             Inquiry Reply SMS &nbsp <span class="badge badge-primary"><?= $inquiry_data['name']?></h3>
          </div>
        </div>
      </div>
        <div class="card card-default color-palette-bo">
      ...
      <div class="col-12">
        <div class="card">
            <div class="card-header d-flex p-0">
              <h3 class="card-title p-3"><i class="fa fa-paper-plane"></i> SMS </h3>
              <ul class="nav nav-pills ml-auto p-2">
                <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">Compose SMS</a></li>
                <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab">Sent SMS List</a></li> 
              </ul>
            </div> 
                ...
                <div class="tab-pane active" id="tab_1">
                  <div class="card-body ">   
                    ...
                    <div class="error"> </div>
                      ...
                      <?php echo form_open_multipart(base_url('Inquiry/send_replysms/'.$inquiry_data['id']), 'class="form-horizontal" id ="myform"');  ?>
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <input type="submit" name="submit" value="Send SMS" class="btn btn-info pull-right">
                          </div>
                        </div>
                      <?php echo form_close( ); ?>
                    <!-- box-body -->
...
<script> 
  var table = $('#na_datatable').DataTable({
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('inquiry/datatable_json_reply_sms/'.$inquiry_data['id'])?>",
    "order": [[3,'desc']],
    "columnDefs": [

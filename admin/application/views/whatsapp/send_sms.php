       ...
       <div class="card card-default color-palette-bo ">
        ...
        <div class="card-header">
          ...
          <div class="d-inline-block">
              ...
              Send New Whatsapp </h3>

          </div>

          <div class="d-inline-block float-right">

            <a href="<?= base_url('Whatsapp'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Whatsapp Msg List</a>
          </div>
        </div>
      </div>
      ...
      <div class="card card-default color-palette-bo col-lg-8 m-3">
        ...
        <div class="card-body ">   
          ...
          <div class="error"> </div>
            ...
            <?php echo form_open_multipart(base_url('Whatsapp/add'), 'class="form-horizontal" id ="myform"');  ?> 

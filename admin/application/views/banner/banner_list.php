    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="d-inline-block float-right"> 
          <a href="<?= base_url('banner/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New Banner</a>
        </div>
      </div>
    </div>
    <div class="card">
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('banner/datatable_json')?>",
    "order": [[4,'desc']],
    "columnDefs": [
...
<script type="text/javascript">
  $("body").on("change",".tgl_checkbox",function(){
    console.log('checked');
    $.post('<?=base_url("banner/change_status")?>',
    {

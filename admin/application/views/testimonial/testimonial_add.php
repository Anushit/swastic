      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('testimonial/add'), 'class="form-horizontal" id="testimonialForm"');  ?>                            
              ...
              <div class="form-group row"> 
                <div class="col-sm-12">
                  ...
                  <textarea name="message" class="form-control" id="message" ><?= set_value('message'); ?></textarea> 
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add Testimonial" class="btn btn-submit btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->

                                    ...
                                    <div class="contact-area ptb-110">
                                        <div class="container">
                                            ...
                                            <div class="section-title">
                                                ...
                                                <h2>Inquery For <?=$serviceInquery['name']?></h2>
                                            </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-md-8">
                                                    ...
                                                    <div class="contact-form">
                                                        <div>
                                                                <form action="<?=BASE_PATH?>service_inquery?id=<?=$serviceInquery['id']?>" id="contactForm" name="contactForm" enctype="multipart/form-data" method="post">

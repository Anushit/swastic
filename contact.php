                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-md-8">
                                                    ...
                                                    <div class="contact-form">
                                                        <div>
                                                                <form action="<?=BASE_PATH.'contact'?>" id="contactForm" name="contactForm" enctype="multipart/form-data" method="post">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                                                            <div class="contact-info-box">
                                                                                <div class="icon" <?php if (empty($email)){?>style="display:none"<?php } ?>>
                                                                        ...
                                                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                                                            <div class="contact-info-box">
                                                                                <div class="icon" <?php if (empty($address)){?>style="display:none"<?php } ?>>
                                                                                    <i class='bx bx-map'></i>
                                                                                </div>
                                                                                <h3>Location Here</h3>
                                                                                <p><?=$address; ?></p>
                                                                            ...
                                                                            <div class="contact-info-box">
                                                                                <div class="icon" <?php if (empty($phone)){?>style="display:none"<?php } ?>>

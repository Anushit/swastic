													...
													<div class="elementor-widget-container">
														...
														<div class="services-details-overview">
															<div class="services-details-image">
																<img class="smartify" sm-src="<?=ADMIN_PATH.$details['data']['image']?>" width="300" height="300" alt=""/>
															</div>
															<div class="services-details-desc text-left">
																<h3><?=$details['data']['meta_title']?></h3>
																<p class="p" style="text-align: justify;"><?=mb_strimwidth($details['data']['sort_description'],0,100,"...")?></p>
																
																<ul class="features-list">
																	<li><i class="bx bx-check-double"></i><p style="text-align: justify;"><?=$details['data']['description']?></p></li>
																</ul> </div>

																<div class="nav-side col-md-4 col-sm-12 col-xs-12">
                                                             <div class="inner">
                                                           <h2>Service Inquery</h2>
                                                           <div class="link-box"><a href="<?=BASE_PATH?>service_inquery?id=<?=$details['data']['id']?>" class="btn btn-primary">Inquery Here</a></div>
                                                           </div>
                                                           </div>  
															</div>
